...
const CardItem = (props) => {
  ...
  const onAddOverlay = async (obj)=>{
    try{
      ...
      if(findOverlay){
        axios.delete(`https://644b903f17e2663b9df26afd.mockapi.io/cart/${findOverlay.id}`)
        props.setOverlayItems((over) => over.filter(o=>o.myId !== obj.myId))
      }
      else{
        const {data} = await axios.post('https://644b903f17e2663b9df26afd.mockapi.io/cart', obj)
